...
export default {
  ...
  computed: {
    /**
     * Visual manipulation rules of the card
     */
    showMediaContent() {
      // console.warn(this.$slots.media, this.imgSrc, this.showMedia)
      const hasMedia = this.$slots.media || this.imgSrc
      console.warn('---hasMedia---', hasMedia)
      console.warn('---showMedia---', this.showMedia)
